...
(() => {
    ...
    const I18N = {
        es: {
            ...
            welcome: "Hola. Escribe el nombre (o parte del nombre) de la persona que buscas — consulto 17 plataformas a la vez. Abajo tienes el directorio de emergencia con teléfonos y portales.",
            ...
            searching_steps: [
                "Conectando con las 17 plataformas…",
        ...
        en: {
            ...
            welcome: "Hi. Type the name (or part of the name) of the person you're looking for — I check 17 platforms at once. The emergency directory with phone lines and portals is below.",
            ...
            searching_steps: [
                "Connecting to all 17 platforms…",
    ...
    // ---------- COMPARTIR ----------
    const SHARE_TEXT = {
        es: "🇻🇪 Busca personas desaparecidas del terremoto de Venezuela en 17 plataformas a la vez — sin instalación:",
        en: "🇻🇪 Search for missing persons from the Venezuela earthquake across 17 platforms at once — no install:",
    };
